...
{
    private const string in_flight_version = "1.0.5";
    private static readonly string[] versions = ["1.0.0", "1.0.1", "1.0.2", "1.0.3", "1.0.4", in_flight_version];
    ...
    private static void ForceDeleteDirectory(string dir)
    {
        ...
        foreach (var path in paths)
        {
            ...
            var failed = Directory.Exists(dir);
            Console.WriteLine(failed ? "FAIL" : "SUCCESS");
