...
| `tomat.environmentmodlist` | none                         | Displays environment information and plugins in the Mods List.                                                                                                                                                                          |
| `tomat.assethotreloading` | none                         | Enables asset hot reloading and automatic shader compilation in-game.                                                                                                                                                                          |
